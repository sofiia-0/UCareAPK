...
import com.example.ucareapk.pantallasinicio.PantallaNuevaContrasenia
import com.example.ucareapk.pantallasinicio.PantallaRecuperarCuenta
import com.example.ucareapk.pantallasinicio.PantallaSignUp
import com.example.ucareapk.pantallasinicio.PantallaVerificarCodigo
...
fun AppNavigate() {
    ...
    /*--------------------------------------------------------------------
    Primero empieza con "NavHost", colocas el navController (la val) y luego el origen del destino
    ...
    NavHost(navController = navController, startDestination = "pantallaInicio") {
        ...
        composable("pantallaInicio") {
            PantallaInicio(
                ...
                onNavigateToLogIn = { navController.navigate("pantallaLogIn") } // Nueva navegación
            )
        }
        ...
        composable("RecuperarCuenta") { PantallaRecuperarCuenta(navController) }

        composable("VerificarCodigo") { PantallaVerificarCodigo(navController) }

        composable("NuevaContra") { PantallaNuevaContrasenia(navController) }
